  ...
  <head>
    ...
    <style>
      ...
      .radiobox { display: block;
                  ...
                  -ms-user-select: none;
                  user-select: none;}
      .radiobox input { position: absolute;
                        opacity: 0;
                        cursor: pointer;}
  ...
  <body>
    <div class='container'>
      <div class='uicontent'>
        ...
        <div class='row' align='center'>
          <div class='col'>
            <div class='update-button' style='font-family:Abel,sans-serif'>
              <button class='btn btn-warning' type='submit' id='updater' style='width:200px'>Update Monitor</button><br>&nbsp;
            </div>
            <div class='reboot-button' style='font-family:Abel,sans-serif'>
              <button class='btn btn-warning' type='submit' id='rebooter' style='width:200px'>Restart Monitor</button><br>&nbsp;
            </div>
          </div>
        </div>
        <div class='row'>
            ...
            <div class='advancedsettings' style='background-color:#a30000'>
              ...
              <div class='advanced' align='center'>
                ...
                <div class='reset-button' style='font-family:Abel,sans-serif'>
                  <button class='btn btn-warning' type='submit' id='resetter' style='width:200px'>Reset Monitor</button><br>&nbsp;
                </div>
              </div>
            </div>
          </div>
        ...
        <div class='row'>
          <div class='col'>
            <p class='colophon'>Weather Monitor &copy; Tony Smith, 2014-18<br>&nbsp;<br><a href='https://github.com/smittytone/Weather' target='_new'>
